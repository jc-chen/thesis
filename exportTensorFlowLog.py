...
bads = []
data_path = './board_backup/'
for directory in os.listdir(data_path):
	for file in os.listdir(data_path+directory):
		try:
			inputLogFile = data_path + directory + '/' +file
			outputFolder = '../flowlogs/'
			...
			if ('scalars' in summaries):
				print(' ');
				csvname = directory + '_scalars.csv'
				csvFileName =  os.path.join(outputFolder, csvname);
